...
- [ ] Commit and merge onto main; configure Pages to main and verify deployment.
- [ ] Back up local Git history, align the working checkout with main, and remove merged branches.
